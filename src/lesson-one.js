...
/*let square = prompt('Specify the side of one side of a square');
console.log(`The perimeter of the square is:${square*4}`);*/
...
let year = 2020;
console.log(`Your are: ${year-birth}`);*/
...
/*let distance = prompt('How far away is your destination in kilometers?');
let time = prompt('How much time do you have to get there?');
console.log(`You have to drive ${distance/time} km/hour to get to your destination on time`);*/
...
const eur = 0.93;
console.log(`You have ${usd*eur} euros`);*/
...
console.log(`X in the equation a*x+b=0 is: ${-b/a}`);*/
